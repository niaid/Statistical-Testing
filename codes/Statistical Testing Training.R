...
######## Step 1: Read Data ########
## 1st Method: Click from the "Files"
correlation_data <- data.frame(correlation)
correlation_data
## 2nd Method: Read with read.csv
...
kruskal.test(unmatched_one_way_anova$Y, as.factor(unmatched_one_way_anova$Group))
